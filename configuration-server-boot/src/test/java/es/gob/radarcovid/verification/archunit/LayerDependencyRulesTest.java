...
public class LayerDependencyRulesTest {
    ...
    @ArchTest
    static final ArchRule only_mappers_should_only_be_accessed_by_daos_or_mappers_or_contentful =
            classes()
                    .that().resideInAPackage("..mapper")
                    .should().onlyBeAccessed().byAnyPackage("..persistence.impl", "..mapper", "..contentful.impl")
                    .as("Mappers should only be accessed by DAO implementations or Mappers");
    ...
    static final ArchRule only_controllers_or_services_should_use_Loggable_annotation =
            noMethods()
                ...
                .should().beDeclaredInClassesThat().resideOutsideOfPackages("..controller", "..business.impl", "..contentful.impl")
